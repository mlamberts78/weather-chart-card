...
Buy mlamberts78 a coffee.  He pulled 99.99% of this together.  I'm just making a few edits to suit my needs.

[![Buy mlamberts78 a coffee](https://www.buymeacoffee.com/assets/img/custom_images/orange_img.png)](https://www.buymeacoffee.com/mlamberts7I)
...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/dxmnkd316/weather-chart-cardx?style=flat-square)](https://github.com/dxmnkd316/weather-chart-cardx/releases/latest)
![GitHub downloads](https://img.shields.io/github/downloads/dxmnkd316/weather-chart-cardx/total?style=flat-square)
![GitHub release (latest by SemVer including pre-releases)](https://img.shields.io/github/downloads/dxmnkd316/weather-chart-cardx/latest/total)
[![HACS Validate](https://github.com/dxmnkd316/weather-chart-cardx/actions/workflows/validate.yaml/badge.svg)](https://github.com/dxmnkd316/weather-chart-cardx/actions/workflows/validate.yaml)

![weather-chart-card](https://github.com/dxmnkd316/weather-chart-cardx/assets/93537082/bd5b9f6e-4125-4a19-9773-463e6d054bce)
![15-days](https://github.com/dxmnkd316/weather-chart-cardx/assets/93537082/f4de6060-7005-4a6d-b1f3-3aa17c856c73)
...
Icons should be in svg format. Icons should have names as shown [here](https://github.com/dxmnkd316/weather-chart-cardx/blob/master/src/const.js#L24). Example:
![130360372-76d70c42-986c-46e3-b9b5-810f0317f94f](https://github.com/dxmnkd316/weather-chart-cardx/assets/93537082/d3ee55a2-e64f-4354-b36d-9faf6ea37361)

#### Example usage:
###### Card with current time, date and day
![date-time](https://github.com/dxmnkd316/weather-chart-cardx/assets/93537082/ab2c32f7-8c6a-4a7e-84fc-f857a519a725)
```yaml
...
```
###### Style2 chart
![style2](https://github.com/dxmnkd316/weather-chart-cardx/assets/93537082/3067cc43-0e80-492c-b4a5-771b1e44ea17)
```yaml
type: custom:weather-chart-card
...
```
###### Chart only
![Chart-only](https://github.com/dxmnkd316/weather-chart-cardx/assets/93537082/c99d85a4-30d1-4fd9-90ff-877421b39e9b)
```yaml
type: custom:weather-chart-card
entity: weather.my_home
show_main: false
...
###### Custom units
![Units](https://github.com/dxmnkd316/weather-chart-cardx/93537082/e72862ee-9bb7-4f97-9a3c-b17663c458aa)
```yaml
type: custom:weather-chart-card
entity: weather.my_home
units:
