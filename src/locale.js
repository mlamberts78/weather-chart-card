const locale = {
  ...
  ka: {
    'tempHi': 'ტემპერატურა',
    'tempLo': 'ტემპერატურა ღამით',
    'precip': 'ნალექი',
    'feelsLike': 'შეიგრძნება როგორც',
    'units': {
      'km/h': 'კმ/სთ',
      'm/s': 'მ/წმ',
      'mph': 'მილი/სთ',
    ...
    'cardinalDirections': [
      'ჩ', 'ჩ-ჩა', 'ჩა', 'ა-ჩა', 'ა', 'ა-სა', 'სა', 'ს-სა',
      'ს', 'ს-სდ', 'სდ', 'დ-სდ', 'დ', 'დ-ჩდ', 'ჩდ', 'ჩ-ჩდ', 'ჩ'
    ],
    'clear-night': 'მოწმენდილი',
    'cloudy': 'მოღრუბლული',
    'fog': 'ნისლი',
    'hail': 'სეტყვა',
    'lightning': 'ელჭექი',
    'lightning-rainy': 'ელჭექი, წვიმა',
    'partlycloudy': 'ნაწილობრივ მოღრუბლული',
    'pouring': 'ძლიერი წვიმა',
    'rainy': 'წვიმა',
    'snowy': 'თოვლი',
    'snowy-rainy': 'თოვლჭყაპი',
    'sunny': 'მზიანი',
    'windy': 'ქარიანი',
    'windy-variant': 'ქარიანი'
  },
  ru: {
    'tempHi': 'Температура',
